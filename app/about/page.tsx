...
export default function About() {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex flex-col justify-center text-zinc-400 font-sans selection:bg-blue-500/20 py-20">
      <main className="max-w-5xl mx-auto w-full px-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <section className="flex flex-col md:flex-row gap-10 items-center md:items-start mb-24 text-center md:text-left">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg leading-relaxed text-zinc-400 max-w-xl">
              ...
              Atualmente migrando do suporte técnico para a{" "}
              <span className="text-zinc-200">de desenvolvimento</span>.
            </p>
            <div className="flex justify-center md:justify-start gap-4 pt-2">
              <a
                href="/Curriculo_Andre_Fernando.pdf" // Nome exato do arquivo que está na pasta public
                download="Curriculo_Andre_Fernando.pdf" // Nome que o arquivo terá ao ser baixado
                className="group text-[11px] font-mono uppercase tracking-widest text-zinc-100 flex items-center gap-2 hover:text-blue-500 transition-colors cursor-pointer"
              >
                Baixar Currículo
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
          ...
          <section className="space-y-10">
            <h2 className="text-[14px] font-mono uppercase tracking-[0.3em] text-zinc-500 flex items-center gap-3">
              ...
              {data.experiences.map((exp) => {
                ...
                return (
                  <div key={exp.id} className="group relative">
                    ...
                    <div
                      className={`absolute -left-[30px] top-1.5 w-1.5 h-1.5 rounded-full transition-colors ${isExpanded ? "bg-blue-500" : "bg-zinc-800 group-hover:bg-zinc-600"}`}
                    />
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`w-4 h-4 text-zinc-700 transition-transform duration-300 ${isExpanded ? "rotate-180 text-blue-500" : ""}`}
                      />
                    </button>

                    <div className="text-[11px] text-blue-500/70 font-sans mb-3 uppercase">
                      {exp.company}
                    </div>
            ...
            <div className="grid gap-4">
              {data.skills.map((skill) => (
                ...
                >
                  ...
                  <p className="text-[12px] font-sans text-zinc-600 leading-relaxed uppercase">
                    {skill.items}
                  </p>
                </div>
              ))}
